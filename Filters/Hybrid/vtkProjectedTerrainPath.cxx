  ...
  vtkInformation*, vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  vtkPolyData* lines = vtkPolyData::SafeDownCast(linesInfo->Get(vtkDataObject::DATA_OBJECT()));
  ...
  for (EdgeListIterator iter = this->EdgeList->begin(); iter != this->EdgeList->end(); ++iter)
  {
  ...
  outLines->Delete();
  vtkDebugMacro("Produced " << outLines->GetNumberOfCells() << " lines from " << numLines
                            << " input polylines");
