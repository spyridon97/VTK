...
{
  vtkInformation* info =
    this->GetInformation()->Get(vtkAlgorithm::INPUT_ARRAYS_TO_PROCESS())->GetInformationObject(0);
...
{
  vtkInformation* info =
    this->GetInformation()->Get(vtkAlgorithm::INPUT_ARRAYS_TO_PROCESS())->GetInformationObject(1);
  return info->Get(vtkDataObject::FIELD_NAME());
}
...
{
  vtkInformation* info =
    this->GetInformation()->Get(vtkAlgorithm::INPUT_ARRAYS_TO_PROCESS())->GetInformationObject(2);
  return info->Get(vtkDataObject::FIELD_NAME());
}
...
{
  vtkInformation* info =
    this->GetInformation()->Get(vtkAlgorithm::INPUT_ARRAYS_TO_PROCESS())->GetInformationObject(3);
  return info->Get(vtkDataObject::FIELD_NAME());
}
...
{
  vtkInformation* info =
    this->GetInformation()->Get(vtkAlgorithm::INPUT_ARRAYS_TO_PROCESS())->GetInformationObject(4);
  return info->Get(vtkDataObject::FIELD_NAME());
}
...
{
  vtkInformation* info =
    this->GetInformation()->Get(vtkAlgorithm::INPUT_ARRAYS_TO_PROCESS())->GetInformationObject(5);
  return info->Get(vtkDataObject::FIELD_NAME());
}

int vtkPointSetToLabelHierarchy::FillInputPortInformation(int port, vtkInformation* info)
{
  if (port == 0)
  {
...
int vtkPointSetToLabelHierarchy::RequestData(vtkInformation* vtkNotUsed(request),
  vtkInformationVector** inputVector, vtkInformationVector* outputVector)
{
  ...
  vtkDataArray* priorities =
    vtkArrayDownCast<vtkDataArray>(this->GetInputAbstractArrayToProcess(0, inputVector));
  vtkDataArray* sizes =
    vtkArrayDownCast<vtkDataArray>(this->GetInputAbstractArrayToProcess(1, inputVector));
  vtkAbstractArray* labels = this->GetInputAbstractArrayToProcess(2, inputVector);
  vtkIntArray* iconIndices =
    vtkArrayDownCast<vtkIntArray>(this->GetInputAbstractArrayToProcess(3, inputVector));
  vtkDataArray* orientations =
    vtkArrayDownCast<vtkDataArray>(this->GetInputAbstractArrayToProcess(4, inputVector));
  vtkDataArray* boundedSizes =
    vtkArrayDownCast<vtkDataArray>(this->GetInputAbstractArrayToProcess(5, inputVector));
